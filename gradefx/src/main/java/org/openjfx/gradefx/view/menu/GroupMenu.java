...
public class GroupMenu extends Menu {
	...
	public GroupMenu() {
		...
		MenuItem menuItemNew = new MenuItem(Controller.translate("menu_group_new"));
		menuItemNew.setOnAction(_ -> new DialogAddGroup().showAndWait());
		this.getItems().add(menuItemNew);

		MenuItem menuItemEdit = new MenuItem(Controller.translate("menu_group_edit"));
		menuItemEdit.setOnAction(_ -> new DialogEditGroup(GroupsPane.getSelectedGroup()).showAndWait());
		this.getItems().add(menuItemEdit);

		MenuItem menuItemDelete = new MenuItem(Controller.translate("menu_group_delete"));
		...
		MenuItem menuItemEditSubjects = new MenuItem(Controller.translate("menu_group_editSubjects"));
