...
public class DialogEditSubTestGroupSystem extends DialogEdit<TestGroupSystem> {
	...
	public DialogEditSubTestGroupSystem(TestGroupSystem testGroupSystem) {
		super(TranslationController.translate("dialog_edit_testGroupSystem_title"), testGroupSystem);
		...
		super.addInput(this.weight, TranslationController.translate("testGroup_weight"));
	}
