...
import gradefx.view.tab.GroupTab;
...
public class GroupsPane extends AddTabPane {
	...
	public final static int TAB_HEAD_SIZE = 50;
	...
	private GroupsPane() {
		...
		this.setTabMinWidth(TAB_HEAD_SIZE + 5);
		this.setTabMinHeight(TAB_HEAD_SIZE + 5);
		this.setTabMaxWidth(TAB_HEAD_SIZE + 5);
		this.setTabMaxHeight(TAB_HEAD_SIZE + 5);
