...
public class DialogEditTestGroupSystems extends DialogUserInput<Boolean> {
	...
	public DialogEditTestGroupSystems() {
		...
		// FIXME this is not always the right one, but adding constants to
		// TestGroupSystem creates new problems when reading from file
		choiceBox.getItems().remove(TestGroupSystem.getTestGroupSystems().get(0));
