...
public class StudentParserDialog extends DialogUserInput<Boolean> {
	...
	public StudentParserDialog(Group group, File file) throws IOException {
		...
		this.firstNameCol = new TableColumn<Student, String>(Translator.get("student_firstName"));
		...
		this.lastNameCol = new TableColumn<Student, String>(Translator.get("student_lastName"));
		...
		this.subgroupNameCol = new TableColumn<Student, String>(Translator.get("student_subgroupName"));
