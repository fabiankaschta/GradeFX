...
public class DialogEditTest extends DialogEdit<Test> {
	...
	public DialogEditTest(Group group, Test test) {
		...
		this.shortName = new UserInputTextInput(new TextFieldPromptText(Translator.get("test_shortName")),
				test.getShortName());
		super.addInput(this.shortName, Translator.get("test_shortName"));
