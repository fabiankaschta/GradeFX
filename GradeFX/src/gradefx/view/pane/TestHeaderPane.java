...
//	private final UserInputChoiceBoxTreeItem<TestGroup> testGroupTree;
	...
	public TestHeaderPane(Group group, Test test) {
		...
		Label nameLabel = new Label(Translator.get("test_name"));
		...
		Label dateLabel = new Label(Translator.get("test_date"));
		...
		Label totalPointsLabel = new Label(Translator.get("test_totalPoints"));
		...
		Label weightPointsLabel = new Label(Translator.get("test_weight"));
