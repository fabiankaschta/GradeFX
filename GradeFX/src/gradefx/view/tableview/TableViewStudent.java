...
import kafx.view.tableview.TableCellEditConverter;
...
public class TableViewStudent extends TableView<Student> {
	...
	public TableViewStudent(Group group, boolean editable) {
		...
		TableColumn<Student, String> lastNameCol = new TableColumn<Student, String>(Translator.get("student_lastName"));
